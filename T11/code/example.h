// This is a trick to allow to define t and dt as integer or double, depending
...
class vec
{
  ...
  {
    return (vec(comp[1] * _x.comp[2] - comp[2] * _x.comp[1], comp[2] * _x.comp[0] - comp[0] * _x.comp[2], comp[0] * _x.comp[1] - comp[1] * _x.comp[0]));
  }
  ...
  {
    return (vec(comp[0] * _x, comp[1] * _x, comp[2] * _x));
  }
  vec operator/(double _x)
  {
    return (vec(comp[0] / _x, comp[1] / _x, comp[2] / _x));
  ...
  {
    return (vec(comp[0] + _x.comp[0], comp[1] + _x.comp[1], comp[2] + _x.comp[2]));
  }
  vec operator-(const vec &_x)
  {
    return (vec(comp[0] - _x.comp[0], comp[1] - _x.comp[1], comp[2] - _x.comp[2]));
...
inline vec operator*(double _a, const vec &_x)
{
  return (vec(_a * _x.comp[0], _a * _x.comp[1], _a * _x.comp[2]));
}
